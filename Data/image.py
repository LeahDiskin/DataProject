...
new_images_csv = Path(r"C:\Users\user1\Documents\bootcamp\Project\new_images.csv")
...
def flat_image_to_metrix(flat_img):
    flat_img = flat_img.reshape(3, cifar10_image_size[0], cifar10_image_size[1])
...
def image_to_csv(image_name,label,path):
    new_images_csv
